...
S3_KEY = os.getenv("S3_OBJECT_KEY")  # exemplo: "videos/video_do_dia.mp4"
...
import sys  # para encerrar o script localmente
...
async def on_ready():
    ...
    await client.close()
    sys.exit(0)  # <- encerra o processo quando roda localmente
